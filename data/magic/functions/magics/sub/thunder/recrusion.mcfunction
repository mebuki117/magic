...
execute unless entity @a[gamemode=survival,distance=..2,scores={magic_lb_dummy=0}] if entity @s[distance=..30] positioned ^ ^ ^1 if block ^ ^ ^ air run function magic:magics/sub/thunder/recrusion
