scoreboard objectives add magic_wpstick minecraft.used:minecraft.warped_fungus_on_a_stick
scoreboard objectives add magic_cooldown dummy
scoreboard objectives add magic_cd_stage dummy
...
scoreboard objectives add magic_acbar_temp dummy
...
scoreboard players set @a magic_temp 0
scoreboard players set @a magic_acbar_temp 0